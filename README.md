...
| [periksa-moralis.yml](.github/workflows/periksa-moralis.yml) | manual saja | Memeriksa apakah `MORALIS_API_KEY` diterima Moralis (ada/tidak, bentuk JWT, diterima/ditolak) tanpa mencetak isinya. Jalankan sesudah memperbarui secret |
