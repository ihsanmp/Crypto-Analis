...
| [cloud/investors.py](cloud/investors.py) | Kepemilikan on-chain multi-chain: 10 holder teratas + kategori otomatis + konsentrasi riil. Ethereum via Ethplorer (tanpa key); Base/Arbitrum/Optimism/Polygon via Blockscout, Avalanche via Routescan (tanpa key). BSC & Solana: tidak ada sumber gratis |
