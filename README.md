...
| `cloud/data/percakapan.json` | **Ingatan percakapan pendek** — 3 pasang tanya-jawab terakhir per chat (kedaluwarsa 6 jam) supaya pesan lanjutan seperti "lanjutkan dengan acuan news" tidak kehilangan konteks. Balasan dipangkas 500 karakter; isi yang memuat alamat dompet/saldo pribadi **ditolak di level kode** |
